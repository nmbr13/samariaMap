...
},
{
    ...
    modelThumb2: 'http://placehold.it/100x100/444444',
    modelPhoto0: 'http://placehold.it/750x500',
    modelPhoto1: 'http://placehold.it/750x500',
    modelPhoto2: 'http://placehold.it/750x500',
},
{
    name: 'cBarrow',
...
function renderInformation(obj) {
    ...
    var thumb2 = obj.modelThumb2;
    var image0 = obj.modelPhoto0;
    var image1 = obj.modelPhoto1;
    var image2 = obj.modelPhoto2;
    ...
    if (title != null) {
        ...
        document.getElementById('modelContainer').children[2].innerHTML = '<a href="' + image2 + '" data-lightbox="stuff"><img src="' + thumb2 + '" alt=""></a>';
